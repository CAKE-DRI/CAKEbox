...
Example format: [Example external link](https://www.cake.ac.uk/)
...
- Fork the repository and create a branch. 
- Find the relevant theme and create a MarkDown file to write your resource. We recommend using the [Contribution Template](contribution-template.md) to get started!
- Add a title and tag so it appears automatically in the list of resources 
- Submit your PR for review! 

### (4) I want to create a new theme 

If you want to create a new theme, follow the guidance in our **[guide for contributing a new central theme](template-of-theme-index.md).**
...
2. Fork the [CAKEbox repository](https://github.com/CAKE-DRI/CAKEbox).  
...
!!! question "New to GitHub?"
    ...
    - [Edit a page in your browser](github-webpages.md)
